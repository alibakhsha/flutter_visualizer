...
import 'package:get/get.dart';
import 'package:test1/controllers/radio_controller.dart';
import 'package:test1/views/animated_visualizer_widget.dart';
          ...
          children: [
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(
                      height: 150,
                      child: Obx(() => AnimatedVisualizerWidget(
                        bars: controller.bars.toList(),
                        height: 120,
                        barColor: Colors.blueAccent,
                      )),
                    ),
            ...
            Obx(() {
              return ElevatedButton.icon(
                ...
                onPressed: () async {
                  try {
                    await controller.togglePlayPause(radioUrl);
                  } catch (e) {
                    Get.snackbar(
                      'Error',
                      'Failed to ${controller.isPlaying.value ? 'pause' : 'play'} radio',
